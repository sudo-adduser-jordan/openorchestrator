...
export function GET() {
  ...
  const lines: string[] = [
    ...
    "- **Any CLI agent**: OpenCode, OpenCode, Cursor, Aider, Goose, and 18 more. 23 harnesses total, with per-project agent choice.",
