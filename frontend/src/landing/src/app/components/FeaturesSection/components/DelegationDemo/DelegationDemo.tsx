...
type SessionId = "orc" | "opencode" | "opencode" | "cursor";
...
const TYPING_MS = 26;
const workerOrder: WorkerId[] = ["opencode", "opencode", "cursor"];
...
const SCRIPT: Step[] = [
	...
	{ type: "pause", ms: 260 },
	{ type: "line", session: "opencode", tone: "working", text: "delegated from manager: cover the callback flow with integration tests", marker: "❯" },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Write(tests/auth/callback.spec.ts)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "Scaffolded happy-path callback case", marker: "⎿" },
	{ type: "pause", ms: 200 },
	{ type: "stream", session: "opencode", text: "Building the happy path and stale-state cases before opening the PR so checks can start early." },
	{ type: "pause", ms: 100 },
	{ type: "line", session: "opencode", tone: "fg", text: "Read(tests/helpers/auth-fixtures.ts)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "Reusing existing GitHub callback fixture helpers", marker: "⎿" },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(npm test -- auth/callback --runInBand)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "11 passing, 1 flaky stale-state assertion", marker: "⎿" },
	{ type: "pause", ms: 170 },
	...
	{ type: "pause", ms: 900 },
	{ type: "blank", session: "opencode" },
	{ type: "line", session: "opencode", tone: "fg", text: "Edit(tests/auth/callback.spec.ts)", marker: "⏺" },
	{ type: "pause", ms: 140 },
	{ type: "line", session: "opencode", tone: "dim", text: "Stale-state assertion now stable across retries", marker: "⎿" },
	{ type: "pause", ms: 120 },
	{ type: "stream", session: "opencode", text: "Adding the callback success path, stale-state rejection, and redirect preservation into one focused spec file." },
	{ type: "pause", ms: 200 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(npm test -- auth/callback --runInBand)", marker: "⏺" },
	{ type: "pause", ms: 140 },
	{ type: "line", session: "opencode", tone: "success", text: "Tests  12 passed (12)", marker: "⎿" },
	{ type: "pause", ms: 120 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(gh pr create --fill)", marker: "⏺" },
	{ type: "pause", ms: 180 },
	{ type: "line", session: "opencode", tone: "dim", text: "Opened PR #52", marker: "⎿" },
	{ type: "sessionStatus", session: "opencode", label: "In review", tone: "#facc15", breathe: true },
	{ type: "pause", ms: 520 },
	...
	{ type: "pause", ms: 180 },
	{ type: "line", session: "opencode", tone: "working", text: "delegated from manager: add digest query coverage", marker: "❯" },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Write(internal/alerts/digest_query_test.go)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "Added missing stale-window fixture", marker: "⎿" },
	{ type: "pause", ms: 160 },
	{ type: "stream", session: "opencode", text: "Covering the empty-recipient and stale-window query cases first so the PR can open early." },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(go test ./internal/alerts/...)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "Query suite green, opening PR next", marker: "⎿" },
	{ type: "pause", ms: 180 },
	...
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(gh pr create --fill)", marker: "⏺" },
	{ type: "pause", ms: 160 },
	{ type: "line", session: "opencode", tone: "dim", text: "Opened PR #67", marker: "⎿" },
	{ type: "sessionStatus", session: "opencode", label: "In review", tone: "#facc15", breathe: true },
	{ type: "pause", ms: 480 },
	{ type: "cursor", target: "session-cursor", click: true },
	{ type: "switch", session: "cursor" },
	...
	{ type: "pause", ms: 180 },
	{ type: "line", session: "opencode", tone: "working", text: "delegated from manager: run mobile QA for pricing", marker: "❯" },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(pnpm test mobile-pricing -- --viewport=390)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "390px footer overlap reproduced", marker: "⎿" },
	{ type: "pause", ms: 160 },
	{ type: "stream", session: "opencode", text: "Checking the narrow viewports first. One footer overlap still needs a quick product call." },
	{ type: "pause", ms: 90 },
	{ type: "line", session: "opencode", tone: "fg", text: "Bash(pnpm test mobile-pricing -- --viewport=430)", marker: "⏺" },
	{ type: "pause", ms: 80 },
	{ type: "line", session: "opencode", tone: "dim", text: "430px and 768px both clean", marker: "⎿" },
	{ type: "pause", ms: 180 },
	...
	{ type: "pause", ms: 930 },
	{ type: "blank", session: "opencode" },
	{ type: "line", session: "opencode", tone: "error", text: "Decision needed: stack CTA buttons at 390px?", marker: "⏺" },
	{ type: "sessionStatus", session: "opencode", label: "Needs input", tone: status.needsYou, breathe: true },
	{ type: "pause", ms: 480 },
	{ type: "cursor", target: "session-cursor", click: true },
	{ type: "switch", session: "cursor" },
	{ type: "pause", ms: 1010 },
...
export function DelegationDemo() {
	...
	const start = useCallback(() => {
		...
		if (reduce) {
			setActiveProject("solkit-ui");
			setSpawned(["orc", "opencode", "opencode", "cursor"]);
			setActive("opencode");
			setStatusesByProject({
				"solkit-ui": {
					opencode: { label: "Ready", tone: status.ready, breathe: false },
					opencode: { label: "In review", tone: "#facc15", breathe: true },
				...
				"northstar-web": {
					opencode: { label: "Ready", tone: status.ready, breathe: false },
					opencode: { label: "Needs input", tone: status.needsYou, breathe: true },
			...
			setLinesBySession({
				...
				[sessionKey("metrics-api", "opencode")]: [{ id: "r14", tone: "fg", text: "Add digest query coverage.", marker: "❯" }],
				...
				[sessionKey("northstar-web", "opencode")]: [{ id: "r18", tone: "error", text: "Decision needed: stack CTA buttons at 390px?", marker: "⏺" }],
